...
public class JsonPathTest {
	...
	public void learning() {
		...
		System.out.println(context.read("$.[0:2]").toString());                     // it excludes the element with index 2
		System.out.println(context.read("$.[?(@.name=='Eraser')]").toString());     // define a condition
	}
}
